...
<body>
  ...
  <header class="top-header">
    ...
    <div class="account-cart">
      ...
      <a href="Lufule_cart.php" class="cart">
  ...
  <main class="cart-page">
    <h1>Shopping Cart – Lufule</h1>

    <?php if (empty($cartItems)): ?>
      <p>Your cart for <strong>Lufule</strong> is empty. 
         <a href="Lufule.php">Continue Shopping</a></p>
    <?php else: ?> 
      ...
      <div class="summary">
        ...
        <a href="checkout.php?branch=Lufule">
