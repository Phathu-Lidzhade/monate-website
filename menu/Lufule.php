...
<head>
  ...
  <title>Monate Menu - Lufule</title>
...
<body>
  ...
  <header class="top-header">
    ...
    <div class="account-cart">
      ...
      <a href="<?php echo isset($_SESSION["user_id"]) 
            ? "Lufule_cart.php?branch=" . urlencode($branchLocation) 
  ...
  <div class="location-bar">
    <a href="Lufule.php" class="location-item active">
  ...
  <div id="item-detail" class="item-detail hidden">
    <div class="detail-content">
      ...
      <div class="detail-right">
        ...
        <!-- Add to Cart -->
        <form method="POST" action="Lufule_add_to_cart.php" onsubmit="return validateSauceSelection()">
